...
export const DashboardFormMapping: React.FC = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      // Departments are now handled by useDepartments hook
    } catch (error) {
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3">
                      <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${((mapping.dashboardType || (mapping as any).dashboard_type) === 'patient')
                  ...
                  <div className="flex items-center space-x-2">
                    <button
                      ...
                      className={`p-2 rounded-lg transition-colors ${mapping.isEnabled
